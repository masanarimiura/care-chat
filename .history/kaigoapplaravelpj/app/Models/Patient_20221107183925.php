...
class Patient extends Model
{
    ...
    public function workers(){
        return $this->belongsToMany(Worker::class,'comments','patient_id','worker_id')->withPivot('content','created_at');
    }

    public function clients(){
        return $this->belongsToMany(Client::class,'comments','patient_id','client_id')->withPivot('content','created_at');
    }
