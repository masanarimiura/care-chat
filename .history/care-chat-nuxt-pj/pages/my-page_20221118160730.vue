      ...
      <div class="my-page_box">
        ...
        <div v-if="$store.state.clientOrWorker == 'worker'" class="worker_box">
          ...
          <div class="shop-box">
            ...
            <div v-if="workerInfo.shop_id == null" class="shop-info-">
              <p class="shop-unregister">現在、登録情報はありません。</p>
            </div>
            <div v-if="workerInfo.shop_id">
              ...
              <p v-if="workerInfo.shop.email == null" class="shop-email">メールアドレス:未登録</p>
              <p v-if="workerInfo.shop.number" class="shop-number">電話番号:{{ workerInfo.shop.number }}</p>
              <p v-if="workerInfo.shop.number == null" class="shop-number">電話番号:{{ workerInfo.shop.number }}</p>
            </div>
          </div>
        </div>
