    ...
    <modal name="modal-reset-password" height="auto">
      ...
      <div class="modal-body">
        <div class="reset-password">
          ...
          <p v-on:click="hideResetPassword()" class="hide-btn">編集を中止する</p>
        </div>
      </div>
    </modal>
  </div>
      ...
      .catch((error) => {
        switch (error.code) {
            case 'auth/user-disabled':
              alert('入力頂いたアカウントのサービスの利用が停止されています。内容をご確認の上再度お試し下さい。');
              break;
            case 'auth/user-not-found':
              alert('メールアドレスまたはパスワードが違います。内容をご確認の上再度お試し下さい。');
              break;
            case 'auth/wrong-password':
              alert('パスワードが間違っています。内容をご確認の上再度お試し下さい。');
              break;
            case 'auth/requires-recent-login':
              alert('認証の有効期限が切れています。内容をご確認の上再度お試し下さい。');
              break;
            case 'auth/requires-recent-login':
