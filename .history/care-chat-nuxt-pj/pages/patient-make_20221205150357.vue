        ...
        <div class="form">
          <validation-observer ref="obs" v-slot="ObserverProps">
            ...
            >
              ...
              />
              <div class="error">{{ errors[0] }}</div>
              <div v-if="this.error == true" class="error">既に使用されているパスワードになります。他のパスワードを選択して下さい</div>
            </validation-provider>
            <validation-provider
              v-slot="{ errors }"
...
export default {
  ...
  methods: {
    ...
    async make() {
      ...
      console.log(getNewPatientId.status)
      console.log(getNewPatientId.data.message)
      // 既に存在するpasswordの場合
