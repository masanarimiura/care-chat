  ...
  <div>
    ...
    <div class="thanks">
      <div class="thanks_box">
        ...
        <p class="thanks_box_btn" @click="join()">チャットID:「{{ this.patientName }}」へ戻る</p>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  async created() {
    ...
    const getPatientInfo = await this.$axios.get("http://127.0.0.1:8000/api/v1/patient/" { params: patientId });
