      ...
      <div class="my-page_box">
        <div v-if="$store.state.clientOrWorker == 'worker'" class="worker_box">
          ...
          <div class="number-box">
            ...
            <p v-if="workerInfo.number == null" class="number">
              電話番号:未登録
            </p>
          </div>
          <div class="role-box">
          ...
          <div class="shop-box">
            ...
            <div></div>
            <p v-if="workerInfo.shop_id == null" class="shop-unregister">
              現在、登録情報はありません。
            </p>
            <p v-if="workerInfo.shop_id" class="shop-name">
              事業所名:{{ workerInfo.shop.name }}
            </p>
            <p v-if="workerInfo.shop_id" class="shop-type">
              分類:{{ workerInfo.shop.shop_type }}
            </p>
            <p v-if="workerInfo.shop_id" class="shop-email">
              メールアドレス:{{ workerInfo.shop.email }}
            </p>
            <p v-if="workerInfo.shop_id" class="shop-number">
