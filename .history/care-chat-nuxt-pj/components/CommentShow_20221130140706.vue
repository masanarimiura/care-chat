      ...
      <div class="v-for_box" v-for="comment in comments" :key="comment.id">
        <div class="client-balloon" v-if="comment.client_id == !null && comment.worker_id == null">
          <div @click="otherClientMyPage(comment.client_id)" class="client-balloon_img-box">
            <img v-if="comment.client.icon_path == null" src="../img/client.jpg" alt="client" class="icon-default" />
            <img v-if="comment.client.icon_path" :src="`${$axios.defaults.baseURL}${comment.client.icon_path}`" alt="../img/client.jpg" class="icon-own" />
            <p class="client_name">
        ...
        <div class="worker-balloon" v-if="comment.worker_id == !null && comment.client_id == null">
          <div @click="otherWorkerMyPage(comment.worker_id)" class="worker-balloon_img-box">
            <img v-if="comment.worker.icon_path == null" src="../img/worker.jpg" alt="client" class="icon-default" />
            <img v-if="comment.worker.icon_path" :src="`${$axios.defaults.baseURL}${comment.worker.icon_path}`" alt="../img/worker.jpg" class="icon-own" />
            <p class="worker_name">
