<template>
  <div v-if="$store.state.clientOrWorker == 'client'" class="client_box">
    <div class="img-box">
      <img v-if="clientInfo.icon_path == null" src="../img/client.jpg" alt="client" class="icon" />
      <img v-if="clientInfo.icon_path" src="../../care-chat-laravel-pj/care-chat-laravel-pj/public/storage/icon/TuPammEzXpqQBPVyBCN3H84tt3g4PKXe8KzTDhKa.jpg" alt="client-icon" class="icon" />
