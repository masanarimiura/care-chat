<template>
  <div v-if="$store.state.clientOrWorker == 'worker'" class="worker_box">
    <div class="img-box">
      <img v-if="workerInfo.icon_path == null" src="../img/worker.jpg" alt="client" class="icon-default" />
      <img v-if="workerInfo.icon_path" :src="`${$axios.defaults.baseURL}${workerInfo.icon_path}`" alt="client-icon" class="icon-own" />
      <span @click="showUpdateIcon(workerInfo.icon)" class="editable">
