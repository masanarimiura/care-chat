        ...
        <div class="client-balloon" v-if="comment.client_id == !null && comment.worker_id == null">
          <div class="client-balloon_img-box">
            ...
            <p class="client_name">
              ...
              <span v-if="searchRelation(comment.client.relations,comment.patient_id) == false ">クライアント:</span>
...
export default {
  ...
  methods: {
    ...
    // コメントのclientのrelationを検索
    searchRelation(ClientRelations,PatientId){
      if(ClientRelations.include){
