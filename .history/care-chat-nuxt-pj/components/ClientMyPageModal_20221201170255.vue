      ...
      <div class="modal-body">
        <div class="update-icon">
          <input
            ...
            @change="checkIcon"
          />
          <p v-if="this.overSizeIcon == true" class="error">画像が10MBを超えています。10MB以下のみ使用可能です</p>
          <p v-if="this.exceptionIcon == true" class="error">ファイル形式が読み取れません。jpg,jpeg,png,gif,tif,tiff,psd,svg など他の形式をお試し下さい。</p>
          <button
