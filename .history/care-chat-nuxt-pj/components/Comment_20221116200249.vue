  ...
  <div>
    ...
    <div class="Chat-area">
      ...
      <modal name="modal-put">
        <p>{{ commentId }}{{commentContent}}更新でモーダルウィンドウで表示されるコンテンツ</p>
      </modal>
      <modal name="modal-delete">
        <p>{{ commentId }}{{commentContent}}削除でモーダルウィンドウで表示されるコンテンツ</p>
      </modal>
    </div>
...
.client-balloon_comment-box .put-delete {
  position: absolute;
  top: 10px;
  right: 10px;
}
.client-balloon_comment-box .put-delete img {
  width: 20px;
  cursor: pointer;
}
...
.worker-balloon_comment-box .put-delete {
  position: absolute;
  top: 10px;
  right: 10px;
}
.worker-balloon_comment-box .put-delete img {
  width: 20px;
  cursor: pointer;
}
