  ...
  <div>
    ...
    <div class="Chat-area">
      ...
      <div class="v-for_box"  v-for="comment in comments" :key="comment.id">
        <div class="client-balloon"  v-show="comment.client_id == !null && comment.worker_id == null">
          ...
          <div class="client-balloon_comment">
            <div class="client-balloon_comment-box">
              ...
              <div class="put-delete" v-show="checkCommentClientID(comment.client_id)">
                <img @click="showPut(comment.id)" src="../img/put.png" alt="put" class="put_btn">
                <img @click="showDelete(comment.id)" src="../img/delete.png" alt="delete_btn" class="delete_btn">
              </div>
...
export default {
  ...
  methods: {
    ...
    checkCommentClientID(commentClientId) {
