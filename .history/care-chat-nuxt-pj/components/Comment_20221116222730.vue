<template>
  <div>
    ...
    <div class="Chat-area">
      ...
      <modal name="modal-put" height="auto">
        ...
        <div class="modal-body">
          <div class="comment-form">
            ...
            <p v-on:click="hidePut()" class="hide-btn">編集を中止する</p>
          </div>
        </div>
      </modal>
      ...
      <modal name="modal-delete" height="auto">
        ...
        <div class="modal-body">
          <div class="delete-content_box"></div>
          <p class="delete-content">{{this.commentContent}}</p>
          <button
            @click="deleteComment()"
            class="comment-form_btn"
          >
          ...
          <p v-on:click="hideDelete()" class="hide-btn">コメントの削除を中止する</p>
        </div>
      </modal>
...
export default {
  ...
  methods: {
    ...
    async updateComment() {
      ...
      await this.$axios
        .put(
          "http://127.0.0.1:8000/api/v1/comment/" + this.commentId,
