    ...
    <div class="Chat-area">
      <div class="v-for_box"  v-for="comment in comments" :key="comment.id">
        <div class="client-balloon"  v-if="comment.client_id == !null">
          <div class="client-balloon_imgArea">
...
.Chat-area .client-balloon {
  width: 100%;
  display: flex;
  flex-wrap: wrap;
  justify-content: flex-start;
}
.Chat-area .client-balloon .imgArea {
  width: 16%;
  position: relative;
}
...
.Chat-area .client-balloon .imgArea .client_name {
  position: absolute;
  top: 0px;
  left: 40px;
  color: rgb(80, 36, 0);
}
.Chat-area .client-balloon:nth-child(odd) .imgArea img {
  left: 0;
  padding-right: 30px;
}
.Chat-area .client-balloon:nth-child(even) .imgArea img {
  right: 0;
  padding-left: 30px;
}
.Chat-area .client-balloon .fukiArea {
  width: 63%;
}
