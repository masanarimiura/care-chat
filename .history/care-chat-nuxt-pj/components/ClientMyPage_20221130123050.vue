<template>
  <div v-if="$store.state.clientOrWorker == 'client'" class="client_box">
    <div class="img-box">
      ...
      <img v-if="clientInfo.icon_path" src="../../care-chat-laravel-pj/care-chat-laravel-pj/storage/icon/TuPammEzXpqQBPVyBCN3H84tt3g4PKXe8KzTDhKa.jpg" alt="client-icon" class="icon" />
