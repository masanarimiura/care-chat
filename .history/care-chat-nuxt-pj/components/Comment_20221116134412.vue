<template>
  <div>
    ...
    <div class="section">
      <div class="oneArea">
        <div class="onebox"  v-for="patient in patientsData" :key="patient.patient.name" @click="joinRecord(patient.patient.id)">
          <div class="imgArea">
            <img src="../img/worker.png" alt="worker" />
            <p class="worker_name">作業療法士:三浦雅成</p>
          </div>
          <div class="fukiArea" v-for="patient in patientsData" :key="patient.patient.name" @click="joinRecord(patient.patient.id)">
            <div class="fukidasi">
