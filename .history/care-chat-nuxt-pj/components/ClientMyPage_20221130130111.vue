<template>
  <div v-if="$store.state.clientOrWorker == 'client'" class="client_box">
    <div class="img-box">
      <img v-if="clientInfo.icon_path == null" src="../img/client.jpg" alt="client" class="icon-defau" />
      <img v-if="clientInfo.icon_path" :src="`${$axios.defaults.baseURL}${clientInfo.icon_path}`" alt="client-icon" class="icon-picture" />
...
.client_box .img-box .icon-picture {
  width: 100px;
}
