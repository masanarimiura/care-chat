        ...
        <div class="client-balloon"  v-if="comment.client_id == !null">
          ...
          <div class="client-balloon_comment">
            <div class="client-balloon_comment-box">
              ...
              <div class="put-delete" v-if="this.$store.state.clientOrWorker == 'client' && comment.client_id == this.$store.state.loginUserId ">
                <img src="../img/put.png" alt="put" class="put_btn">
