        ...
        <div class="client-balloon"  v-if="comment.client_id == !null && comment.worker_id == null">
          ...
          <div class="client-balloon_comment">
            <div class="client-balloon_comment-box">
              ...
              <div class="put-delete" v-show="this.$store.state.clientOrWorker == 'client' && commentClientId == this.$store.state.loginUserId">
...
export default {
  ...
  methods: {
    ...
    showPut(commentId) {
      this.$modal.show("modal-put",commentId);
    },
    hidePut() {
