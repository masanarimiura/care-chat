      ...
      <div class="modal-body">
        <div class="update-icon">
          <validation-observer ref="obs" v-slot="ObserverProps">
            <validation-provider v-slot="{ errors }" rules="ext:jpg,jpeg,png,gif,tif,tiff,psd,svg">
            <input
              type="file"
              name="アイコン"
              required
              accept="image/jpg,image/jpeg,image/png,image/gif,image/tif,image/tiff,image/psd,image/png,image/png"
              @change="checkIcon; ProviderProps.validate"
            />
