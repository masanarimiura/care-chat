...
.Chat-area .onebox .imgArea {
  width: 16%;
  position: relative;
}
.Chat-area .onebox .imgArea img {
  width: 100%;
  max-width: 130px;
  position: absolute;
  top: 30px;
}
.Chat-area .onebox .imgArea .worker_name {
  position: absolute;
  top: 0px;
  color: rgb(80, 36, 0);
}
.Chat-area .onebox .imgArea .client_name {
  position: absolute;
  top: 0px;
  left: 40px;
  color: rgb(80, 36, 0);
}
.Chat-area .onebox:nth-child(odd) .imgArea img {
  left: 0;
  padding-right: 30px;
}
.Chat-area .onebox:nth-child(even) .imgArea img {
  right: 0;
  padding-left: 30px;
}
.Chat-area .onebox .fukiArea {
  width: 63%;
}
.Chat-area .onebox .fukidasi {
  width: 100%;
  position: relative;
  padding: 25px;
...
.Chat-area .onebox .fukidasi .datetime {
  text-align: right;
  font-size: 16px;
  padding-top: 10px;
}
.Chat-area .onebox .fukidasi::before {
  content: "";
  position: absolute;
  display: block;
  top: 22px;
...
.Chat-area .onebox:nth-child(odd) .fukidasi::before {
  left: -20px;
}
.Chat-area .onebox:nth-child(even) .fukidasi {
  background-color: rgb(211, 252, 237);
}
.Chat-area .onebox:nth-child(even) .fukidasi::before {
  right: -20px;
