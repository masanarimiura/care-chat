...
.Chat-area .client-balloon .datetime {
  text-align: right;
  font-size: 12px;
  padding-top: 10px;
}
...
.Chat-area .client-balloon:nth-child(odd) .client-balloon_comment-box::before {
  left: -20px;
}
.Chat-area .client-balloon:nth-child(even) .client-balloon_comment-box {
  background-color: rgb(211, 252, 237);
}
.Chat-area .client-balloon:nth-child(even) .client-balloon_comment-box::before {
  right: -20px;
...
@media screen and (max-width: 1024px) {
  ...
  .Chat-area .client-balloon .client-balloon_comment-box {
    padding: 15px;
    font-size: 14px;
  }
  .Chat-area .client-balloon .client-balloon_comment-box::before {
    top: 8px;
  }
}
</style>