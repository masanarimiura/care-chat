  ...
  <div>
    ...
    <div class="Chat-area">
      ...
      <div class="v-for_box"  v-for="(comment,comment_index) in comments" :key="comment.id">
        <div class="client-balloon"  v-if="comment.client_id == !null && comment.worker_id == null">
          ...
          <div class="client-balloon_comment">
            <div class="client-balloon_comment-box">
              ...
              <div class="put-delete" v-if="$store.state.clientOrWorker == 'client' && comment.client_id == $store.state.loginUserId ">
                <p>{{comment_index}}:
                  <img @click="showPut(comment.client_id)" src="../img/put.png" alt="put" class="put_btn">
                  <img @click="showDelete()" src="../img/delete.png" alt="delete_btn" class="delete_btn">
                </p>
              </div>

              <modal name="modal-put">
                <p>更新でモーダルウィンドウで表示されるコンテンツ</p>
              </modal>
        ...
        <div class="worker-balloon" v-if="comment.worker_id == !null && comment.worker_id == null">
