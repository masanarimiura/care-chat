      ...
      <div class="register__box">
        ...
        <validation-observer ref="obs" v-slot="ObserverProps">
          ...
          <validation-provider v-slot="{ errors }" rules="required">
            <input v-model="relation_id" type="relation_id" name="患者様との関係" required placeholder="患者様との関係" />
            <div class="error">{{ errors[0] }}</div>
          </validation-provider>
          <br />
          ...
          <br />
          <validation-provider v-slot="{ errors }" rules="digits:8-12">
            <input v-model="number" type="number" name="電話番号" required placeholder="電話番号" />
            <div class="error">{{ errors[0] }}</div>
          </validation-provider>
          <br />
