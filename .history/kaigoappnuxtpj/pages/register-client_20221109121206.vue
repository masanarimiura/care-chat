  ...
  <div>
    ...
    <div class="register-client">
      <div class="register-client_box">
        ...
        <p class="register-client_box_content">※医療福祉従事者の方患者様ご本人・ご家族様等の方のみこちらより作成をお願いします。</p>
        <p class="register-client_box_content">※は<NuxtLink to="/register-worker">クライアント新規登録</NuxtLink>ページへ移動して下さい。</p>
