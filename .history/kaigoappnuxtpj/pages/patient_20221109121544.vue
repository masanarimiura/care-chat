<template>
  <div>
    ...
    <div class="login-register_ttl">
      <h2>患者様チャットへのログインもしくは新規登録</h2>
      <h2>アカウントページ</h2>
      <p>※患者様チャットページを利用するにはまず、ご本人様の<NuxtLink to="/register-client">「クライアントアカウント」</NuxtLink>もしくは,<NuxtLink to="/register-worker">「ケアワーカーアカウント」</NuxtLink>の作成が必要です。</p>
