<template>
  <div>
    ...
    <div class="login-register_ttl">
      <h2>ご利用者様</h2>
      <h2>アカウントページ</h2>
      <p>※患者様チャットページを利用するにはまず、
        ご本人様の<NuxtLink to="/register-client">「クライアントアカウント」</NuxtLink>もしくは,
        <NuxtLink to="/register-worker">「ケアワーカーアカウント」</NuxtLink>の作成が必要です。</p>
      <p>※患者様ご本人様も
        <NuxtLink to="/register-client">「クライアントアカウント」</NuxtLink>の作成が必要になります。</p>
    </div>
