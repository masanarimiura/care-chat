  ...
  <div>
    ...
    <div class="register-worker">
      <div class="register-worker_box">
        <h3 class="register-worker_box_ttl">クライアント新規登録</h3>
        <p class="register-worker_box_content">※患者様ご本人・ご家族様等のみこちらより作成をお願いします。</p>
        <p class="register-worker_box_content">※医療福祉従事者の方は<NuxtLink to="/register-worker">ケアワーカー新規登録</NuxtLink>ページへ移動して下さい。</p>
