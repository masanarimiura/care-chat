  ...
  <div>
    ...
    <div class="register-client">
      <div class="register-client_box">
        ...
        <p class="register-client_box_content">※患者様ご本人・ご家族様等はこちらより作成をお願いします。</p>
        <p class="register-client_box_content">※医療福祉従事者の方は<NuxtLink to="/register-worker">ケアワーカー新規登録</NuxtLink>ページへ。</p>
...
.register-client_box_content,.login_box_content{
  margin-top: 10px;
  font-size: 12px;
}
