  ...
  <div>
    ...
    <div class="login-register_ttl">
      ...
      <p>※患者様チャットページを利用するにはまず、
        ご本人様の<NuxtLink to="/register-worker">「クライアントアカウント」</NuxtLink>もしくは,
        <NuxtLink to="/register-worker">クライアント新規登録</NuxtLink>「ケアワーカーアカウント」の作成が必要です。</p>
      <p>※患者様ご本人様も
        「クライアントアカウント」の作成が必要になります。</p>
    </div>
