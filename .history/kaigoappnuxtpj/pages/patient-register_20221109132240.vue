  ...
  <div>
    ...
    <div class="register-client">
      <div class="register-client_box">
        ...
        <p class="register-client_box_content">※既に作成済みのチャットに参加を希望する場合は作成者と「チャットID」「パスワード」を共有し、<NuxtLink to="/patient" class="nuxt-link">
        <img src="../img/logo.png" class="header-in_img">
        <div class="header-in_ttl">
          <h2>Care</h2>
          <h2>Chat</h2>
        </div>
      </NuxtLink>「チャットに参加」を利用して下さい。</p>
        <br />
