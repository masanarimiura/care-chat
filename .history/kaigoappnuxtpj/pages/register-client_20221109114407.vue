  ...
  <div>
    ...
    <div class="register-client">
      <div class="register-client_box">
        <h3 class="register-client_box_ttl">ケアワーカー新規登録</h3>
        <p class="register-client_box_content">※患者様ご本人・ご家族様等医療福祉従事者の方のみこちらより作成をお願いします。</p>
        <p class="register-client_box_content">※医療福祉従事者の方は<NuxtLink to="/register-worker">クライアント新規登録</NuxtLink>ページへ移動して下さい。</p>
